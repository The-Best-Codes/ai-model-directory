...
- Always use decimal.js for any arithmetic on prices, token counts, monetary values, and more where JS floating point math could cause issues.
...
- Please note your agent type, model, and other relevant details to fast-track getting your PRs reviewed and merged. Failure to do so may result in your PR being delayed or rejected.
