...
- 11 models added, 0 models removed
...
- 0 models added, 23 models removed

| Field | Lost | Gained | Changed |
| --- | ---: | ---: | ---: |
| `features.attachment` | 0 | 53 | 1 |
| `features.reasoning` | 0 | 53 | 0 |
| `pricing.input` | 0 | 27 | 1 |
| `pricing.cache_read` | 0 | 0 | 1 |
| `limit.context` | 0 | 27 | 0 |
| `limit.output` | 0 | 27 | 0 |

<details>
<summary>Removed models (23)</summary>
...
- 3 models added, 2 models removed
...
- 4 models added, 40 models removed
- No field-level changes among existing models
...
<details>
<summary>Removed models (40)</summary>
...
- `google/gemini-3.1-flash-image-preview@us-east1`
- `google/gemini-3.1-flash-image-preview@us-east5`
- `google/gemini-3.1-flash-image-preview@us-south1`
- `google/gemini-3.1-flash-image-preview@us-west1`
- `openai/chatgpt-4o`
...
- Total models added: 40
- Total models removed: 68

| Field | Lost | Gained | Changed |
| --- | ---: | ---: | ---: |
| `name` | 0 | 0 | 4 |
| `release_date` | 0 | 1 | 279 |
| `last_updated` | 0 | 0 | 5 |
| `features.attachment` | 0 | 53 | 1 |
| `features.reasoning` | 0 | 53 | 0 |
| `features.structured_output` | 0 | 0 | 10 |
| `features.tool_call` | 0 | 0 | 7 |
| `pricing.input` | 0 | 27 | 153 |
| `pricing.output` | 0 | 0 | 135 |
| `pricing.cache_read` | 4 | 0 | 17 |
| `limit.context` | 0 | 27 | 2 |
| `limit.output` | 2 | 27 | 0 |
...
| --- | ---: | ---: | ---: |
| `release_date` | 0 | 0 | 14 |
| `features.attachment` | 9 | 14 | 0 |
| `pricing.input` | 0 | 0 | 61 |
| `pricing.output` | 0 | 0 | 58 |
| `modalities.input` | 0 | 0 | 23 |
...
| --- | ---: | ---: | ---: |
| `last_updated` | 8 | 0 | 0 |
| `features.attachment` | 9 | 0 | 0 |
| `pricing.input` | 0 | 0 | 73 |
| `pricing.output` | 0 | 0 | 64 |
| `limit.context` | 7 | 0 | 0 |
| `modalities.input` | 9 | 0 | 0 |
| `modalities.output` | 6 | 0 | 0 |

### nano-gpt

- 0 models added, 10 models removed
- No field-level changes among existing models
...
- 4 models added, 8 models removed
- No field-level changes among existing models
...
- `vertex/claude-opus-4-7@europe-west1`
- `vertex/claude-opus-4-7@europe-west2`
- `vertex/claude-opus-4-7@europe-west3`
- `vertex/claude-opus-4-7@europe-west4`
- `vertex/claude-opus-4-7@europe-west6`
- `vertex/claude-opus-4-7@us-central-1`
- `vertex/claude-opus-4-7@us-east1`
- `vertex/claude-opus-4-7@us-west-1`
...
- Total models removed: 29

| Field | Lost | Gained | Changed |
| --- | ---: | ---: | ---: |
| `release_date` | 0 | 0 | 214 |
| `last_updated` | 8 | 0 | 0 |
| `open_weights` | 0 | 0 | 1 |
| `features.attachment` | 18 | 14 | 0 |
| `features.structured_output` | 0 | 0 | 8 |
| `features.tool_call` | 0 | 0 | 7 |
| `pricing.input` | 0 | 3 | 138 |
| `pricing.output` | 0 | 3 | 124 |
| `pricing.cache_read` | 0 | 0 | 2 |
| `pricing.cache_write` | 0 | 0 | 8 |
| `limit.context` | 7 | 2 | 1 |
| `limit.output` | 1 | 14 | 0 |
| `modalities.input` | 9 | 0 | 23 |
| `modalities.output` | 6 | 0 | 0 |
...
- 0 models added, 144 models removed
- No field-level changes among existing models

<details>
<summary>Removed models (144)</summary>
...
- 0 models added, 8 models removed
- No field-level changes among existing models
...
- 0 models added, 6 models removed
- No field-level changes among existing models
...
- Total models removed: 173

| Field | Lost | Gained | Changed |
| --- | ---: | ---: | ---: |
| `name` | 0 | 0 | 1 |
| `release_date` | 1 | 0 | 266 |
| `last_updated` | 0 | 0 | 1 |
| `features.attachment` | 0 | 0 | 18 |
| `features.structured_output` | 0 | 0 | 7 |
| `features.tool_call` | 0 | 0 | 6 |
| `pricing.input` | 0 | 0 | 151 |
| `pricing.output` | 0 | 0 | 134 |
| `pricing.cache_read` | 0 | 27 | 6 |
| `pricing.cache_write` | 0 | 0 | 1 |
| `limit.context` | 0 | 0 | 3 |
| `limit.output` | 2 | 2 | 2 |
| `modalities.input` | 0 | 0 | 30 |
...
- 1 models added, 8 models removed
- No field-level changes among existing models
...
- 15 models added, 0 models removed

| Field | Lost | Gained | Changed |
| --- | ---: | ---: | ---: |
| `release_date` | 0 | 0 | 14 |
| `pricing.input` | 0 | 0 | 46 |
| `pricing.output` | 0 | 0 | 43 |
...
- 6 models added, 3 models removed
- No field-level changes among existing models
...
| Field | Lost | Gained | Changed |
| --- | ---: | ---: | ---: |
| `pricing.input` | 8 | 0 | 73 |
| `pricing.output` | 5 | 0 | 64 |
...
- Providers updated: 49
- Total models added: 42
- Total models removed: 17
...
| `features.structured_output` | 0 | 0 | 8 |
| `features.tool_call` | 0 | 0 | 9 |
| `pricing.input` | 14 | 1 | 139 |
| `pricing.output` | 11 | 1 | 124 |
| `pricing.cache_read` | 3 | 2 | 4 |
| `pricing.cache_write` | 2 | 0 | 0 |
| `limit.context` | 0 | 1 | 2 |
| `limit.output` | 0 | 0 | 4 |
...
- 6 models added, 15 models removed

| Field | Lost | Gained | Changed |
| --- | ---: | ---: | ---: |
| `release_date` | 0 | 0 | 14 |
| `pricing.input` | 0 | 0 | 40 |
| `pricing.output` | 0 | 0 | 37 |
...
<details>
<summary>Removed models (15)</summary>
...
- 2 models added, 6 models removed
...
- 2 models added, 4 models removed
...
- 21 models added, 1 models removed
- No field-level changes among existing models
...
| `features.tool_call` | 0 | 0 | 11 |
| `pricing.input` | 0 | 7 | 0 |
| `pricing.output` | 0 | 7 | 0 |
| `modalities.input` | 0 | 0 | 7 |
...
| `features.attachment` | 0 | 0 | 6 |
| `features.structured_output` | 0 | 0 | 6 |
| `features.tool_call` | 0 | 0 | 19 |
| `pricing.input` | 1 | 7 | 121 |
| `pricing.output` | 1 | 7 | 109 |
| `pricing.cache_read` | 2 | 0 | 6 |
| `limit.context` | 0 | 0 | 5 |
| `limit.output` | 2 | 2 | 4 |
| `modalities.input` | 0 | 0 | 23 |
...
- 39 models added, 0 models removed
- No field-level changes among existing models
...
- 12 models added, 1 models removed
- No field-level changes among existing models
...
| Field                        | Lost | Gained | Changed |
| ---------------------------- | ---: | -----: | ------: |
| `features.structured_output` |    0 |      2 |       4 |
| `features.tool_call`         |    0 |      2 |       4 |
| `pricing.input`              |    1 |      3 |       1 |
| `pricing.output`             |    1 |      3 |       1 |
| `limit.context`              |    0 |      3 |       0 |
